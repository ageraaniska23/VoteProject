...
import backgroundImage from '../assets/image/register.png';
...
const SignUp = ({ setIsAuthenticated }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-800 py-6 flex flex-col justify-center sm:py-12 md:py-16 lg:py-20" 
