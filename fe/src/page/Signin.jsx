      ...
      <div className="relative py-3 sm:max-w-xl sm:mx-auto mt-14">
        ...
        <div className="text-white relative px-4 py-10 bg-indigo-400 shadow-lg sm:rounded-3xl sm:p-20">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {loginError && (
              <div
                className="flex items-center p-4 mb-4 text-sm text-red-800 rounded-full bg-red-50 dark:bg-gray-800 dark:text-red-400"
                role="alert"
              >
                <svg
          ...
          <p className="text-gray-300 mt-4 text-center">
            ...
            <Link
              to="/SignUp"
              className="block text-center mt-4 hover:underline hover:text-cyan-600 transition-all"
            >
