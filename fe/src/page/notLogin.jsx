    ...
    <section className="bg-white dark:bg-gray-900 h-screen flex items-center">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <p className="mb-4 text-3xl tracking-tight font-bold text-white md:text-4xl dark:text-white">Login dulu boss.</p>
          <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Maaf Anda dapat mengakses menu lainnya jika sudah mendaftar dan login </p>
