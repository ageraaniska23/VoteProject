    ...
    <div className='h-screen'>
      <section className="bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-40">
          <div className="">
            <h2 className="mb-4 mt-14 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white text-center">About Us</h2>
            <p className="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400 text-center">
          ...
          <div className="justify-center">
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 ">
              <a>
                <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://media.licdn.com/dms/image/C5603AQFBpUyU0jPUyA/profile-displayphoto-shrink_400_400/0/1651417649116?e=1707955200&v=beta&t=dpE3v1Uh6x4PZg-0hDcSTO-qGGF1MRfIILxUAHWsXt0" alt="Bonnie Avatar" />
              </a>
              <div className="p-10">
                <h3 className="text-6xl font-bold tracking-tight text-gray-900 dark:text-white mb-7">
                  <a>Agera Aniska</a>
                </h3>
                <span className="text-gray-500 dark:text-gray-400">CEO, Web Dev & Solidity Dev</span>
                <p className="mt-7 mb-7 font-light text-gray-500 dark:text-gray-400">Mahasiswa Jurusan Sistem Komputer Universitas Sriwijaya</p>
