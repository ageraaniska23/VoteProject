        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-40">
          ...
          <div className="justify-center">
            <div className="items-center bg-gray-50 rounded-xl shadow sm:flex dark:bg-gray-800 dark:border-gray-700 ">
              <a>
                <img className="w-full rounded-xl sm:rounded-xl" src="https://media.licdn.com/dms/image/C5603AQFBpUyU0jPUyA/profile-displayphoto-shrink_400_400/0/1651417649116?e=1707955200&v=beta&t=dpE3v1Uh6x4PZg-0hDcSTO-qGGF1MRfIILxUAHWsXt0" alt="Bonnie Avatar" />
              </a>
              <div className="p-10">
