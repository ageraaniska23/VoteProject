            ...
            <div className="items-center bg-gray-50 rounded-xl shadow sm:flex dark:bg-gray-800 dark:border-gray-700 ">
              ...
              <div className="p-6 sm:p-10">
                ...
                <span className="text-gray-500 dark:text-gray-400">
                  CEO, Web Dev & Solidity Dev
                </span>
                <p className="mt-2 mb-7 font-light text-gray-500 dark:text-gray-400">
                  Mahasiswa Jurusan Sistem Komputer Universitas Sriwijaya
                </p>
                <ul className="flex space-x-4 sm:mt-4">
                  <li>
                    ...
                    >
                      ...
                      >
                        <image
                          href="https://www.svgrepo.com/show/465458/link-alt-2.svg"
                          width="20"
                          height="20"
                        />
                      </svg>
                  ...
                  <li>
                    ...
                    >
                      ...
                      >
                        <image
                          href="https://www.svgrepo.com/show/448224/facebook.svg"
                          width="20"
                          height="20"
                        />
                      </svg>
                  ...
                  <li>
                    ...
                    >
                      ...
                      >
                        <image
                          href="https://www.svgrepo.com/show/312259/github.svg"
                          width="20"
                          height="20"
                        />
                      </svg>
                  ...
                  <li>
                    ...
                    >
                      ...
                      >
                        <image
                          href="https://www.svgrepo.com/show/452231/instagram.svg"
                          width="20"
                          height="20"
                        />
                      </svg>
                  ...
                  <li>
                    ...
                    >
                      ...
                      >
                        <image
                          href="https://www.svgrepo.com/show/452051/linkedin.svg"
                          width="20"
                          height="20"
                        />
                      </svg>
